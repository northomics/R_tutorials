...
- **argument**: options that are given to a function 
...
# b is the object
# seq is the function
# from, to, by are the arguments
print(b)
```

### Packages and libraries

"Base" R is pretty basic... that is, it doesn't have that many biology specific functions that we often need. The good this is that researchers often write functions and package them up in an R "package". You can install these packages if you need them.
...
## CRAN packages 
# Let's install ggplot2. We will be using this for data visualization. layer on. 
...
Sometimes (ok...often) I forget how exactly to use a function. Luckily there is built in help within R that walks us through what a function does, how to use it, and includes examples. All you need to do is type `?` before your function. Let's try it out
...
**Exercise:** Let's tak *7 mins* to explore these functions do and we'll discuss them :) 
